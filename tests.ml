...
module StringLengthListQueue = (ListQueue(StringLengthCompare) :
                            PRIOQUEUE with type elt = StringLengthCompare.t);;

module StringLengthTreeQueue = (TreeQueue(StringLengthCompare) :
                            PRIOQUEUE with type elt = StringLengthCompare.t);;
 
module StringLengthHeapQueue = (BinaryHeap(StringLengthCompare) :
                            PRIOQUEUE with type elt = StringLengthCompare.t);;
                             
module IntStringListQueue = (ListQueue(IntStringCompare) :
                            PRIOQUEUE with type elt = IntStringCompare.t);;

module IntStringTreeQueue = (TreeQueue(IntStringCompare) :
                            PRIOQUEUE with type elt = IntStringCompare.t);;
 
module IntStringHeapQueue = (BinaryHeap(IntStringCompare) :
                            PRIOQUEUE with type elt = IntStringCompare.t);;


module StringLengthTree = BinSTree(StringLengthCompare)
...
let _ = StringLengthTree.run_tests () ;;
let _ = IntStringTree.run_tests () ;;

(* IntListQueue *)

let _ = IntListQueue.run_tests () ;;
let _ = StringLengthListQueue.run_tests () ;;
let _ = IntStringListQueue.run_tests () ;;


let _ = IntTreeQueue.run_tests () ;;
let _ = StringLengthTreeQueue.run_tests () ;;
let _ = IntStringTreeQueue.run_tests () ;;

let _ = IntHeapQueue.run_tests () ;;
let _ = StringLengthHeapQueue.run_tests () ;;
let _ = IntStringHeapQueue.run_tests () ;;
